(function () {
        ...
        // TODO All scripts that go out should be kept track of, what they invoked and in whar order. That way we can recreate everything from a static string later on.
        function MTaglib() {
                var that         = this;
                var
                        KEY      = 'key',
